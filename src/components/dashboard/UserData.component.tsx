  ...
  return (
    <Card w="xs" p="2" position="relative">
      ...
      <Heading
        ...
        mt={14}
      >
        {isLoading ? <SkeletonText /> : data?.users_by_pk?.first_name}&nbsp;
      ...
      <SimpleGrid fontSize="0.8rem" gap={4} columns={3}>
        {isLoading ? (
          ...
          <>
            ...
            <HStack alignItems="center" as={Text}>
              <DurationIcon
                aria-label="total ride duration this week"
                role="img"
              />
              <Text as="span">
            ...
            <HStack alignItems="center" as={Text}>
              <ElevationIcon
                aria-label="total elevation this week"
                role="img"
              />
              <Text as="span">
                {convertDistance(
      ...
      <SimpleGrid columns={3} fontSize="0.8rem" gap={4}>
        {isLoading ? (
          ...
          <>
            ...
            <HStack alignItems="center" as={Text}>
              <DistanceIcon
                aria-label="total ride distance this year"
                role="img"
              />
              <Text as="span">
                {convertDistance(
                  data?.activitiesYear?.aggregate?.sum!.distance
                )}
              </Text>
            </HStack>
            <HStack alignItems="center" as={Text}>
              <DurationIcon
                role="img"
                aria-label="total ride duration this year"
              />
              <Text as="span">
                {convertDurationForActivityTitle(
            ...
            <HStack alignItems="center" as={Text}>
              <ElevationIcon
                role="img"
                aria-label="total elevation this year"
              />
              <Text as="span">
                {convertDistance(
