...
mutation UpdateUserToken($pk: Int!, $access_token: String!, $refresh_token: String!) {
  update_users_by_pk(pk_columns: {external_id: $pk}, _set: {refresh_token: $refresh_token, access_token: $access_token}) {
    external_id
  }
}
`;
